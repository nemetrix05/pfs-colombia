    ...
    <div class="header-top">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 <?php echo sanitize_html_class( $contact_pull_right ); ?>">
                    <?php get_template_part( 'inc/header/contact', 'info' ); ?>
                </div>
                <?php } ?>

                <?php if( $social != false ) { ?>
                <div class="col-sm-1 hidden-sm hidden-xs <?php echo sanitize_html_class( $social_pull_right ); ?>">
