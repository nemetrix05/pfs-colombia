            ...
            <form method="post" action="" id="agent_detail_contact_form">
                ...
                <div class="form-group">
                    <textarea id="message" rows="3"
                              class="form-control"><?php echo sprintf(esc_html__('Hola %s, Vi su perfil en %s y quisiera saber si me pudiera dar más información', 'houzez'), $agent_name, get_option('blogname')); ?></textarea>
                </div>
